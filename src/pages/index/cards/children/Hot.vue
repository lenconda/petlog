...
.card-wrapper .card-head .card-head-avatar {
...
.card-wrapper .card-head .card-head-poster .poster-name {
  font-size: 18px;
  line-height: 18px;
  color: #000;
}
.card-wrapper .card-head .card-head-poster .poster-date {
  font-size: 12.5px;
  line-height: 12.5px;
  margin-top: 7px;
  color: #9b9b9b;
}
.card-wrapper .card-head .card-head-follow {
  width: 74px;
  height: 47px;
...
.card-wrapper .card-misc .misc-tags {
  position: relative;
  margin-top: 10px;
}
.card-wrapper .card-misc .misc-status::before {
  content: '';
  width: 17px;
  height: 15.5px;
  color: #000;
...
.card-wrapper .card-misc .misc-tags::before {
  content: '';
  width: 15.5px;
  height: 15.5px;
  position: absolute;
...
.card-wrapper .card-control-wrapper {
  width: 100%;
  background-color: #fff;
  box-sizing: border-box;
  padding: 0 14px 0 14px;
}
.card-wrapper .card-control-wrapper .card-control {
  width: 100%;
